...
namespace MoneyMindManager.Domain.Abstractions
{
    public interface IUserRepository
    {
        ...
        /// <returns>Updating Result</returns>
        Task<IResult<bool>> ChangePassword(int userID, string oldPassword, string newPassword,
        ...
        Task<IResult<User>> GetByUserNameAndPassword_Login(string userName, string password);
        ...
        Task<IResult<string>> GetUserSaltByUserName(string userName);
