namespace MoneyMindManager_Presentation.OverView.Controls
{
    partial class ctlDebtsRepaymentSchedule
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ctrlInfoIcon1.ToolTipText = "هذا المخطط يوضح التزاماتك وتوقعاتك المالية (لك/عليك) مقسمة لـ 3 فترات: (متأخر قبل" +
    " اليوم) + (من اليوم وحتى نهاية الشهر) + (5 أشهر كاملة لاحقة) (يشمل الديون التي ل" +
    "ديها تاريخ استحقاق فقط) .";
            // 
