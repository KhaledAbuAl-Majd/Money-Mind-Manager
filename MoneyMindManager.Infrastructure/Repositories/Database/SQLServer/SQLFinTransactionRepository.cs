...
namespace MoneyMindManager.Infrastructure.Repositories.Database.SQLServer
{
    public class SQLFinTransactionRepository : IFinTransactionRepository
    {
        ...
        public async Task<IResult<PagedResultWithValueDTO<FinTransactionViewSummary>>> GetAllPaged(int voucherID, int currentUserID, int pageNumber, byte rowsPerPage)
        {
        ...
        public async Task<IResult<IEnumerable<FinTransactionExportSummary>>> GetAll(int voucherID, int currentUserID)
        {
