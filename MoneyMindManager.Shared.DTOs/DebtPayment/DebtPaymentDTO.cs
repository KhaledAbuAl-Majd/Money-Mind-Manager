...
{
    public class DebtPaymentDTO : MainTransactionDTO
    {
        public int? DebtID { get; set; }
        public DebtPaymentDTO(int? transactionID, decimal amount, DateTime createdDate, short? accountID, int? createdByUserID, byte? tranasactionTypeID, string purpose,
