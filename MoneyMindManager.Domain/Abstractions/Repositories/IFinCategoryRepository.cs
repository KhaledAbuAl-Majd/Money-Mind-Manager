...
namespace MoneyMindManager.Domain.Abstractions.Repositories
{
    public interface IFinCategoryRepository
    {
        ...
        Task<IResult<PagedResultDTO<FinCategorySelectSummary>>> GetAllForSelectOne(FinCategorySelectPagedSearchCriteria criteria, int currentUserID);
        Task<IResult<PagedResultDTO<FinCategoryFullSummary>>> GetAll(FinCategoryPagedSearchCriteria criteria, int currentUserID);
